package com.scrap.bcp.handler;

import com.scrap.bcp.exception.SpringException;
import com.scrap.bcp.exception.ExceptionResponse;
...
public class CustomExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ExceptionResponse> handleAvatarException(final SpringException ex) {
